...
#収集するユーザーネームの指定
target_name = input("twitterのUsernameを入れてね\n")
print(f"{target_name}を探します")
...
class TweetCollector:
    ...
    __user_name = target_name    #取得するTwitterのユーザー名
...
#処理
twc = TweetCollector(target_name) #Twitterのユーザー名を指定
twc.collectTweet()
twc.writeCSV()
